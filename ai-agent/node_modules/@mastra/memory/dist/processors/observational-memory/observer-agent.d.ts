...
export declare function buildObserverHistoryMessage(messages: MastraDBMessage[]): CoreMessage;
/**
...
export declare function buildMultiThreadObserverHistoryMessage(messagesByThread: Map<string, MastraDBMessage[]>, threadOrder: string[]): CoreMessage;
...
export declare function buildObserverTaskPrompt(existingObservations: string | undefined, options?: {
