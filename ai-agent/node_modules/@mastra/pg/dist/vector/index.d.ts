...
import type { IndexConfig, IndexType, PgMetric, VectorType } from './types.js';
export type { PgMetric, VectorOps, VectorType, IndexConfig, IndexType } from './types.js';
...
export declare class PgVector extends MastraVector<PGVectorFilter> {
    ...
    private setupSchema;
    createIndex({ indexName, dimension, metric: rawMetric, indexConfig, buildIndex, vectorType, metadataIndexes, }: PgCreateIndexParams): Promise<void>;
    buildIndex({ indexName, metric, indexConfig, vectorType }: PgDefineIndexParams): Promise<void>;
    private setupIndex;
    private createMetadataIndexes;
