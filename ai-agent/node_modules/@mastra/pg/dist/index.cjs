...
var ObservabilityPG = class _ObservabilityPG extends storage.ObservabilityStorage {
  ...
  async getSpan(args) {
    ...
    try {
      ...
      throw new error.MastraError(
        {
          id: storage.createStorageErrorId("PG", "GET_SPAN", "FAILED"),
          domain: error.ErrorDomain.STORAGE,
          category: error.ErrorCategory.USER,
  ...
  async getRootSpan(args) {
    ...
    try {
      ...
      throw new error.MastraError(
        {
          id: storage.createStorageErrorId("PG", "GET_ROOT_SPAN", "FAILED"),
          domain: error.ErrorDomain.STORAGE,
          category: error.ErrorCategory.USER,
          details: { traceId }
        },
  ...
  async listTraces(args) {
    ...
    try {
      ...
      throw new error.MastraError(
        {
          id: storage.createStorageErrorId("PG", "LIST_TRACES", "FAILED"),
          domain: error.ErrorDomain.STORAGE,
          category: error.ErrorCategory.USER
        },
        error$1
...
var ScoresPG = class _ScoresPG extends storage.ScoresStorage {
  #db;
  #schema;
  #skipDefaultIndexes;
  #indexes;
