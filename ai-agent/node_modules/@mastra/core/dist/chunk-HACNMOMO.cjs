...
function isLSPAvailable() {
  ...
  try {
    const req = module$1.createRequire((typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('chunk-HACNMOMO.cjs', document.baseURI).href)));
...
function createSkillTool(skills) {
  const tool = chunkE7PW4ZAB_cjs.createTool({
    id: "skill",
...
var astEditTool = chunkE7PW4ZAB_cjs.createTool({
...
var deleteFileTool = chunkE7PW4ZAB_cjs.createTool({
...
var editFileTool = chunkE7PW4ZAB_cjs.createTool({
...
var executeCommandTool = chunkE7PW4ZAB_cjs.createTool({
...
var executeCommandWithBackgroundTool = chunkE7PW4ZAB_cjs.createTool({
  id: WORKSPACE_TOOLS.SANDBOX.EXECUTE_COMMAND,
  description: `${baseDescription}
...
var fileStatTool = chunkE7PW4ZAB_cjs.createTool({
...
var getProcessOutputTool = chunkE7PW4ZAB_cjs.createTool({
...
var grepTool = chunkE7PW4ZAB_cjs.createTool({
...
var indexContentTool = chunkE7PW4ZAB_cjs.createTool({
...
var killProcessTool = chunkE7PW4ZAB_cjs.createTool({
...
var listFilesTool = chunkE7PW4ZAB_cjs.createTool({
...
var mkdirTool = chunkE7PW4ZAB_cjs.createTool({
...
var readFileTool = chunkE7PW4ZAB_cjs.createTool({
...
var searchTool = chunkE7PW4ZAB_cjs.createTool({
...
var writeFileTool = chunkE7PW4ZAB_cjs.createTool({
...
//# sourceMappingURL=chunk-HACNMOMO.cjs.map
//# sourceMappingURL=chunk-HACNMOMO.cjs.map