...
var NetlifyGateway = class extends chunk4MKCST44_cjs.MastraModelGateway {
  id = "netlify";
  ...
  async resolveLanguageModel({
    ...
    switch (providerId) {
      case "openai":
        return chunk4MKCST44_cjs.createOpenAI({ apiKey, baseURL, headers: mastraHeaders }).responses(modelId);
      case "gemini":
        return chunk4MKCST44_cjs.createGoogleGenerativeAI({
      ...
      case "anthropic":
        return chunk4MKCST44_cjs.createAnthropic({
          apiKey,
          baseURL: `${baseURL}/v1/`,
          headers: {
...
//# sourceMappingURL=chunk-FVP6VEKR.cjs.map
//# sourceMappingURL=chunk-FVP6VEKR.cjs.map