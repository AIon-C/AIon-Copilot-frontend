...
var entityTypeField = v4.z.nativeEnum(chunkW26XAFT3_cjs.EntityType).describe(`Entity type (e.g., 'agent' | 'processor' | 'tool' | 'workflow')`);
...
var parentEntityTypeField = v4.z.nativeEnum(chunkW26XAFT3_cjs.EntityType).describe("Entity type of the parent entity");
...
var rootEntityTypeField = v4.z.nativeEnum(chunkW26XAFT3_cjs.EntityType).describe("Entity type of the root entity");
...
var scoringEntityTypeSchema = v4.z.enum(["AGENT", "WORKFLOW", ...Object.values(chunkW26XAFT3_cjs.SpanType)]);
...
var spanTypeField = v4.z.nativeEnum(chunkW26XAFT3_cjs.SpanType).describe("Span type (e.g., WORKFLOW_RUN, AGENT_RUN, TOOL_CALL, etc.)");
...
var batchDeleteTracesArgsSchema = v4.z.object({
  traceIds: v4.z.array(traceIdField)
...
//# sourceMappingURL=chunk-USZLACWO.cjs.map
//# sourceMappingURL=chunk-USZLACWO.cjs.map