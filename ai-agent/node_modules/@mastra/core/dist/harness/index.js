import { Mastra } from '../chunk-V5ZXOW33.js';
import { Agent } from '../chunk-6OYGEMV6.js';
import { Workspace, createWorkspaceTools } from '../chunk-RHU25VWO.js';
...
var Harness = class {
  ...
  async getCurrentModelAuthStatus() {
    ...
    try {
      const { PROVIDER_REGISTRY } = await import('../provider-registry-2REK4G5M.js');
