...
var chunkEMB234CP_cjs = require('./chunk-EMB234CP.cjs');
var chunk7ZYGR5WJ_cjs = require('./chunk-7ZYGR5WJ.cjs');
var chunkCFRWCOK6_cjs = require('./chunk-CFRWCOK6.cjs');
var chunkQXQMTR5Q_cjs = require('./chunk-QXQMTR5Q.cjs');
...
var Mastra = class {
  ...
  get datasets() {
    if (!this.#datasets) {
      this.#datasets = new chunkCFRWCOK6_cjs.DatasetsManager(this);
    }
  ...
  constructor(config) {
    ...
    const workflowEventProcessor = new chunkEMB234CP_cjs.WorkflowEventProcessor({ mastra: this });
    ...
    if (storage) {
      storage = chunkF5254W6E_cjs.augmentWithInit(storage);
    }
    if (config?.observability) {
      if (typeof config.observability.getDefaultInstance === "function") {
        ...
        this.#observability = new chunkW26XAFT3_cjs.NoOpObservability();
      }
    } else {
      this.#observability = new chunkW26XAFT3_cjs.NoOpObservability();
    }
    ...
    chunkMR7ZWBL6_cjs.registerHook("onScorerRun" /* ON_SCORER_RUN */, chunkQXQMTR5Q_cjs.createOnScorerHook(this));
  ...
  addAgent(agent, key, options) {
    ...
    let mastraAgent;
    if (chunk7ZYGR5WJ_cjs.isToolLoopAgentLike(agent)) {
      mastraAgent = chunk7ZYGR5WJ_cjs.toolLoopAgentToMastraAgent(agent, { fallbackName: key });
    } else {
      mastraAgent = agent;
    }
   ...
   */
  setStorage(storage) {
    this.#storage = chunkF5254W6E_cjs.augmentWithInit(storage);
  }
  setLogger({ logger }) {
    this.#logger = logger;
    if (this.#agents) {
   ...
   */
  get loggerVNext() {
    return this.#observability.getDefaultInstance()?.getLoggerContext?.() ?? chunkW26XAFT3_cjs.noOpLoggerContext;
  }
  /**
   ...
   */
  get metrics() {
    return this.#observability.getDefaultInstance()?.getMetricsContext?.() ?? chunkW26XAFT3_cjs.noOpMetricsContext;
  }
  getServerMiddleware() {
  ...
  #syncGatewayRegistry() {
    try {
      ...
      import('./provider-registry-73GVT5AT.cjs').then(async ({ GatewayRegistry }) => {
...
//# sourceMappingURL=chunk-MRNTJIUP.cjs.map
//# sourceMappingURL=chunk-MRNTJIUP.cjs.map