...
var chunkAXQA7AJE_cjs = require('./chunk-AXQA7AJE.cjs');
...
var MastraLLMV1 = class extends chunkRO47SMI7_cjs.MastraBase {
  ...
  async __text({
    ...
    if (experimental_output) {
      ...
      if (chunkCYZJ2HT2_cjs.isZodType(experimental_output)) {
        ...
        const jsonSchemaToUse = chunkVWJ7H3MJ_cjs.standardSchemaToJSONSchema(standardSchema);
    ...
    if (tools && Object.keys(tools).length > 0) {
      for (const tool of Object.values(tools)) {
        if (tool.parameters) {
          ...
          } else if (chunkVWJ7H3MJ_cjs.isStandardSchemaWithJSON(tool.parameters)) {
            tool.parameters = schemaCompat.jsonSchema(chunkVWJ7H3MJ_cjs.standardSchemaToJSONSchema(tool.parameters));
          } else {
    ...
    const argsForExecute = {
      ...
      experimental_output: schema ? chunkAXQA7AJE_cjs.output_exports.object({
        schema
      }) : void 0
    };
    try {
      const result = await chunkW26XAFT3_cjs.executeWithContext({
        span: llmSpan,
        fn: () => chunkAXQA7AJE_cjs.generateText(argsForExecute)
      });
  ...
  async __textObject({
    ...
    try {
      ...
      try {
        const result = await chunkAXQA7AJE_cjs.generateObject(argsForExecute);
        llmSpan?.end({
          output: {
            object: result.object,
            warnings: result.warnings
  ...
  __stream({
    ...
    try {
      return chunkW26XAFT3_cjs.executeWithContextSync({ span: llmSpan, fn: () => chunkAXQA7AJE_cjs.streamText(argsForExecute) });
    } catch (e) {
      const mastraError = new chunk4U7ZLI36_cjs.MastraError(
        {
  ...
  __streamObject({
    ...
    try {
      ...
      try {
        return chunkAXQA7AJE_cjs.streamObject(argsForExecute);
      } catch (e) {
        const mastraError = new chunk4U7ZLI36_cjs.MastraError(
          {
...
//# sourceMappingURL=chunk-6IM3BPH2.cjs.map
//# sourceMappingURL=chunk-6IM3BPH2.cjs.map