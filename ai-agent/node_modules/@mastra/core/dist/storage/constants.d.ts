...
export declare const SPAN_SCHEMA: Record<"error" | "runId" | "input" | "threadId" | "resourceId" | "metadata" | "source" | "output" | "createdAt" | "name" | "updatedAt" | "requestContext" | "entityType" | "traceId" | "spanId" | "entityId" | "links" | "endedAt" | "startedAt" | "parentSpanId" | "scope" | "attributes" | "tags" | "spanType" | "isEvent" | "experimentId" | "entityName" | "parentEntityType" | "parentEntityId" | "parentEntityName" | "rootEntityType" | "rootEntityId" | "rootEntityName" | "userId" | "organizationId" | "sessionId" | "requestId" | "environment" | "serviceName", StorageColumn>;
/**
