...
function createSkillTool(skills) {
  const tool = createTool({
    ...
    inputSchema: z$2.object({
      name: z$2.string().describe("The name of the skill to activate")
    }),
    execute: async ({ name }) => {
...
function createSkillSearchTool(skills) {
  const tool = createTool({
    ...
    inputSchema: z$2.object({
      query: z$2.string().describe("The search query"),
      skillNames: z$2.array(z$2.string()).optional().describe("Optional list of skill names to search within"),
      topK: z$2.number().optional().describe("Maximum number of results to return (default: 5)")
    }),
...
function createSkillReadTool(skills) {
  const tool = createTool({
    ...
    inputSchema: z$2.object({
      skillName: z$2.string().describe("The name of the skill"),
      path: z$2.string().describe('Path to the file relative to the skill root (e.g. "references/colors.md", "scripts/run.sh")'),
      startLine: z$2.number().optional().describe("Starting line number (1-indexed). If omitted, starts from the beginning."),
      endLine: z$2.number().optional().describe("Ending line number (1-indexed, inclusive). If omitted, reads to the end.")
    }),
...
Use this after starting a background command with execute_command (background: true) to check if the process is still running and read its output.`,
  ...
  inputSchema: z$1.object({
    pid: z$1.string().describe("The process ID returned when the background command was started"),
    tail: z$1.number().optional().describe(
    ...
    wait: z$1.boolean().optional().describe(
...
Use this to stop a long-running background process that was started with execute_command (background: true). Returns the last ${KILL_TAIL_LINES} lines of output.`,
  toModelOutput: sandboxToModelOutput,
  inputSchema: z$1.object({
    pid: z$1.string().describe("The process ID of the background process to kill")
  }),
...
//# sourceMappingURL=chunk-RHU25VWO.js.map
//# sourceMappingURL=chunk-RHU25VWO.js.map