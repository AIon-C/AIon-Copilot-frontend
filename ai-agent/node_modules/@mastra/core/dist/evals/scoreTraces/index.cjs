...
var getTraceStep = chunkEMB234CP_cjs.createStep({
...
async function validateAndSaveScore({ storage, scorerResult }) {
  ...
  const payloadToSave = chunkUSZLACWO_cjs.saveScorePayloadSchema.parse(scorerResult);
...
var scoreTracesWorkflow = chunkEMB234CP_cjs.createWorkflow({
