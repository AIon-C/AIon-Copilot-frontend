import { MessageList } from './chunk-ESN5IH6I.js';
import { entityTypeField, userIdField, experimentIdField, spanIdField, traceIdField, commonFilterFields, sortDirectionSchema, paginationArgsSchema, paginationInfoSchema, metadataField, tagsField, contextFields, sourceField, resourceIdField, rootEntityNameField, rootEntityTypeField, parentEntityNameField, parentEntityTypeField, requestIdField, threadIdField, sessionIdField, runIdField, TABLE_SCHEMAS, TABLE_SCORERS, listTracesArgsSchema, toTraceSpans, TABLE_WORKFLOW_SNAPSHOT } from './chunk-D3UTRVYG.js';
import { deepEqual } from './chunk-FNVUZ3S2.js';
import { EntityType } from './chunk-DYVLPDXH.js';
...
function resolveZodSchema(zodString) {
  return Function("z", `"use strict";return (${zodString});`)(z$1);
}
