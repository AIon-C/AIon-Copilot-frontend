...
var chunkB67DPK7Q_cjs = require('./chunk-B67DPK7Q.cjs');
var chunkZCBG4ZQT_cjs = require('./chunk-ZCBG4ZQT.cjs');
var chunkHACNMOMO_cjs = require('./chunk-HACNMOMO.cjs');
var chunkSHN25XWN_cjs = require('./chunk-SHN25XWN.cjs');
var chunkCLKMJINC_cjs = require('./chunk-CLKMJINC.cjs');
var chunkFXGVRQSG_cjs = require('./chunk-FXGVRQSG.cjs');
var chunkSPDQUG6O_cjs = require('./chunk-SPDQUG6O.cjs');
var chunkMR7ZWBL6_cjs = require('./chunk-MR7ZWBL6.cjs');
var chunk2AWGYDG4_cjs = require('./chunk-2AWGYDG4.cjs');
var chunk6IM3BPH2_cjs = require('./chunk-6IM3BPH2.cjs');
var chunk6BJ7XHRH_cjs = require('./chunk-6BJ7XHRH.cjs');
var chunkOQDRPRKM_cjs = require('./chunk-OQDRPRKM.cjs');
var chunkCYZJ2HT2_cjs = require('./chunk-CYZJ2HT2.cjs');
var chunkW26XAFT3_cjs = require('./chunk-W26XAFT3.cjs');
  ...
  return {
    tools: filteredTools.map(([name, tool2]) => {
      try {
        ...
        const sdkTool = chunkSPDQUG6O_cjs.tool({
          type: "function",
          ...tool2,
          inputSchema
        });
          ...
          case "function":
            ...
            if (sdkTool.inputSchema) {
              if ("$schema" in sdkTool.inputSchema && typeof sdkTool.inputSchema.$schema === "string" && sdkTool.inputSchema.$schema.startsWith("http://json-schema.org/")) {
                ...
                parameters = chunkSPDQUG6O_cjs.asSchema(sdkTool.inputSchema).jsonSchema;
              }
...
var StructuredOutputProcessor = class {
  ...
  async processOutputStream(args) {
    ...
    const observabilityContext = chunkW26XAFT3_cjs.resolveObservabilityContext(rest);
...
var ProcessorRunner = class _ProcessorRunner {
    ...
    for (const [index, processorOrWorkflow] of this.outputProcessors.entries()) {
      ...
      try {
        ...
        const processResult = await processMethod({
          ...
          abort,
          ...chunkW26XAFT3_cjs.createObservabilityContext({ currentSpan: processorSpan }),
          requestContext,
          retryCount,
          writer
        });
        const mutations = messageList.stopRecording();
        if (processResult instanceof chunkCLKMJINC_cjs.MessageList) {
        ...
        try {
          if (processor.processOutputStream && processedPart) {
            ...
            const result = await processor.processOutputStream({
              ...
              ...chunkW26XAFT3_cjs.createObservabilityContext({ currentSpan: state.span }),
              requestContext,
              messageList,
              retryCount,
              writer
  ...
  async runInputProcessors(messageList, observabilityContext, requestContext, retryCount = 0) {
    for (const [index, processorOrWorkflow] of this.inputProcessors.entries()) {
      ...
      try {
        ...
        let mutations;
        if (result instanceof chunkCLKMJINC_cjs.MessageList) {
  ...
  async runProcessInputStep(args) {
    ...
    const observabilityContext = chunkW26XAFT3_cjs.resolveObservabilityContext(args);
    const stepInput = {
  ...
  static async validateAndFormatProcessInputStepResult(result, {
    ...
    if (result instanceof chunkCLKMJINC_cjs.MessageList) {
      ...
      if (result.model) {
        const resolvedModel = await chunk2AWGYDG4_cjs.resolveModelConfig(result.model);
...
var ObjectFormatHandler = class extends BaseFormatHandler {
  ...
  async processPartialChunk({
    ...
    const { value: currentObjectJson, state } = await chunkFXGVRQSG_cjs.parsePartialJson(processedAccumulatedText);
    if (this.validatePartialChunks && this.partialSchema) {
      const result = this.partialSchema?.safeParse(currentObjectJson);
      if (result.success && result.data && result.data !== void 0 && !chunkFXGVRQSG_cjs.isDeepEqualData(previousObject, result.data)) {
        return {
          shouldEmit: true,
    ...
    if (currentObjectJson !== void 0 && currentObjectJson !== null && typeof currentObjectJson === "object" && !chunkFXGVRQSG_cjs.isDeepEqualData(previousObject, currentObjectJson)) {
      return {
  ...
  async validateAndTransformFinal(finalRawValue) {
    ...
    const { value } = await chunkFXGVRQSG_cjs.parsePartialJson(rawValue);
...
var ArrayFormatHandler = class extends BaseFormatHandler {
  ...
  async processPartialChunk({
    ...
    const processedAccumulatedText = this.preprocessText(accumulatedText);
    const { value: currentObjectJson, state: parseState } = await chunkFXGVRQSG_cjs.parsePartialJson(processedAccumulatedText);
    if (currentObjectJson !== void 0 && !chunkFXGVRQSG_cjs.isDeepEqualData(previousObject, currentObjectJson)) {
      ...
      if (!chunkFXGVRQSG_cjs.isDeepEqualData(this.textPreviousFilteredArray, filteredElements)) {
...
var EnumFormatHandler = class extends BaseFormatHandler {
  ...
  async processPartialChunk({
    ...
    const processedAccumulatedText = this.preprocessText(accumulatedText);
    const { value: currentObjectJson } = await chunkFXGVRQSG_cjs.parsePartialJson(processedAccumulatedText);
    if (currentObjectJson !== void 0 && currentObjectJson !== null && typeof currentObjectJson === "object" && !Array.isArray(currentObjectJson) && "result" in currentObjectJson && typeof currentObjectJson.result === "string" && !chunkFXGVRQSG_cjs.isDeepEqualData(previousObject, currentObjectJson)) {
  ...
  async validateAndTransformFinal(rawFinalValue) {
    ...
    const { value } = await chunkFXGVRQSG_cjs.parsePartialJson(processedValue);
          ...
          async transform(chunk, controller) {
            if (chunk.type === "finish" && chunk.payload?.stepResult?.reason === "tool-calls") {
              ...
              const {
                ...
                chunk,
                processorStates,
                chunkW26XAFT3_cjs.resolveObservabilityContext(options),
            ...
            case "finish":
              ...
              try {
                if (self.processorRunner && !self.#options.isLLMExecutionStep) {
                  ...
                  const outputText = lastResponseMessage ? chunkCLKMJINC_cjs.coreContentToString(lastResponseMessage.content) : "";
  ...
  switch (chunk.type) {
    ...
    case "file":
      if (mode === "generate") {
        return {
          type: "file",
          file: new chunkCLKMJINC_cjs.DefaultGeneratedFile({
      ...
      return {
        type: "file",
        file: new chunkCLKMJINC_cjs.DefaultGeneratedFileWithType({
          data: chunk.payload.data,
          mediaType: chunk.payload.mimeType
        })
      };
...
var createTimeTravelExecutionParams = (params) => {
  ...
  for (const [index, entry] of graph.steps.entries()) {
    ...
    stepIds.forEach((stepId) => {
      ...
      if (result) {
        const formattedResult = chunkCYZJ2HT2_cjs.removeUndefinedValues(result);
  ...
  const results = await Promise.all(
    entry.steps.map(async (step, i) => {
      ...
      const stepExecResult = await engine.executeStep({
        ...
        ...chunkW26XAFT3_cjs.createObservabilityContext({ currentSpan: parallelSpan }),
        pubsub,
        abortController,
        requestContext,
        outputWriter,
      ...
      const context = createDeprecationProxy(
        {
          ...
          state: executionContext.state,
          retryCount: -1,
          ...chunkW26XAFT3_cjs.createObservabilityContext({ currentSpan: evalSpan }),
  ...
  const results = await Promise.all(
    stepsToRun.map(async (step) => {
      ...
      const stepExecResult = await engine.executeStep({
        ...
        ...chunkW26XAFT3_cjs.createObservabilityContext({ currentSpan: conditionalSpan }),
        pubsub,
        abortController,
        requestContext,
        outputWriter,
...
async function executeLoop(engine, params) {
  ...
  do {
    const stepExecResult = await engine.executeStep({
      ...
      ...chunkW26XAFT3_cjs.createObservabilityContext({ currentSpan: loopSpan }),
      pubsub,
      abortController,
      requestContext,
      outputWriter,
    ...
    const evalSpan = await engine.createChildSpan({
      ...
      options: {
        ...
        input: chunkCYZJ2HT2_cjs.selectFields(result.output, ["stepResult", "output.text", "output.object", "messages"]),
        attributes: {
  ...
  if (fn) {
    ...
    duration = await engine.wrapDurableOperation(`workflow.${workflowId}.sleep.${entry.id}`, async () => {
      return fn({
        ...
        retryCount: -1,
        ...chunkW26XAFT3_cjs.createObservabilityContext({ currentSpan: sleepSpan }),
        getInitData: () => stepResults?.input,
        getStepResult: getStepResult.bind(null, stepResults),
  ...
  if (fn) {
    ...
    const dateResult = await engine.wrapDurableOperation(`workflow.${workflowId}.sleepUntil.${entry.id}`, async () => {
      return fn({
        ...
        retryCount: -1,
        ...chunkW26XAFT3_cjs.createObservabilityContext({ currentSpan: sleepUntilSpan }),
        getInitData: () => stepResults?.input,
        getStepResult: getStepResult.bind(null, stepResults),
        // TODO: this function shouldn't have suspend probably?
        suspend: async (_suspendPayload) => {
...
async function executeStep(engine, params) {
  ...
  const stepRetryResult = await engine.executeStepWithRetry(
    ...
    async () => {
      ...
      const mastraForStep = engine.mastra ? isNestedWorkflow ? engine.mastra : chunkW26XAFT3_cjs.wrapMastra(engine.mastra, { currentSpan: stepSpan }) : void 0;
      const output = await runStep({
        ...
        ...chunkW26XAFT3_cjs.createObservabilityContext({ currentSpan: stepSpan }),
        getInitData: () => stepResults?.input,
        getStepResult: getStepResult.bind(null, stepResults),
  ...
  async execute(params) {
    ...
    for (let i = startIdx; i < steps.length; i++) {
      ...
      lastOutput = await this.executeEntry({
        ...
        timeTravel,
        restart,
        ...chunkW26XAFT3_cjs.createObservabilityContext({ currentSpan: workflowSpan }),
...
function createStepFromProcessor(processor) {
  ...
  return {
    ...
    execute: async ({ inputData, requestContext, tracingContext, outputWriter }) => {
      ...
      const processorObservabilityContext = chunkW26XAFT3_cjs.createObservabilityContext(
      ...
      const passThrough = {
        ...
        messageList: messageList ?? (Array.isArray(messages) ? new chunkCLKMJINC_cjs.MessageList().add(messages, "input").addSystem(systemMessages ?? []) : void 0),
        stepNumber,
        systemMessages,
        streamParts,
        state,
        ...
        switch (phase) {
          ...
          case "outputStream": {
            ...
            if (processor.processOutputStream) {
              ...
              const processorObservabilityContext2 = chunkW26XAFT3_cjs.createObservabilityContext(
...
` + errors.map((e) => {
  ...
  async _start({
    ...
    const observabilityContext = chunkW26XAFT3_cjs.resolveObservabilityContext(rest);
    const workflowSpan = chunkW26XAFT3_cjs.getOrCreateSpan({
  ...
  async _resume(params) {
    const observabilityContext = chunkW26XAFT3_cjs.resolveObservabilityContext(params);
    const workflowsStore = await this.#mastra?.getStorage()?.getStore("workflows");
...
var MastraScorer = class _MastraScorer {
  ...
  async run(input) {
    ...
    const observabilityContext = chunkW26XAFT3_cjs.resolveObservabilityContext(input);
  ...
  async executePromptStep(scorerStep, observabilityContext, context) {
    ...
    const resolvedModel = await chunk2AWGYDG4_cjs.resolveModelConfig(modelConfig, void 0, this.#mastra);
...
var AISDKV5InputStream = class extends MastraModelInput {
  ...
  constructor({
    ...
    this.#generateId = generateId2 ?? chunkSPDQUG6O_cjs.generateId;
  }
  async transform({
    runId,
    stream,
      ...
      try {
        ...
        return await pRetry.default(
          ...
          },
          {
            ...
            signal: abortSignal,
            shouldRetry(context) {
              if (chunkSPDQUG6O_cjs.APICallError.isInstance(context.error)) {
        ...
        if (inputStepProcessors && inputStepProcessors.length > 0) {
          ...
          try {
            ...
            const processInputStepResult = await processorRunner.runProcessInputStep({
              ...
              ...chunkW26XAFT3_cjs.createObservabilityContext(stepTracingContext),
              requestContext,
              model,
              steps: inputData.output?.steps || [],
              messageId: currentStep.messageId,
              rotateResponseMessageId: () => {
                currentMessageId = _internal?.generateId?.() ?? chunkSPDQUG6O_cjs.generateId();
            ...
            if (processInputStepResult.tools && currentStep.tools) {
              ...
              for (const [name, tool2] of Object.entries(currentStep.tools)) {
                if (chunkE7PW4ZAB_cjs.isMastraTool(tool2)) {
                  convertedTools[name] = chunkCYZJ2HT2_cjs.makeCoreTool(
                    tool2,
                    {
                      name,
                      runId,
...
Analyse the suspended tools: ${JSON.stringify(suspendedTools)}, using the messages available to you and the resumeSchema of each suspended tool, find the tool whose resumeData you can construct properly.
        ...
        if (isSupportedLanguageModel(currentStep.model)) {
          modelResult = chunkW26XAFT3_cjs.executeWithContextSync({
        ...
        if (currentStep.model instanceof chunk2AWGYDG4_cjs.ModelRouterLanguageModel) {
        ...
        try {
          ...
          const isUpstreamError = chunkSPDQUG6O_cjs.APICallError.isInstance(error);
          if (isUpstreamError) {
      ...
      if (outputProcessors && outputProcessors.length > 0) {
        ...
        try {
          ...
          await processorRunner.runProcessOutputStep({
            ...
            text: immediateText,
            ...chunkW26XAFT3_cjs.createObservabilityContext(outputStepTracingContext),
            requestContext,
...
function createLLMMappingStep({ models, _internal, ...rest }, llmExecutionStep) {
  ...
  const observabilityContext = chunkW26XAFT3_cjs.createObservabilityContext(rest.modelSpanTracker?.getTracingContext());
              ...
              parts: errorResults.map((toolCallErrorResult) => {
                return {
                  ...
                  toolInvocation: {
                    ...
                    toolName: chunkCLKMJINC_cjs.sanitizeToolName(toolCallErrorResult.toolName),
                    ...
                    clientResults.map(async (toolCall) => {
                      ...
                      return {
                        ...
                        toolInvocation: {
                          state: "result",
                          toolCallId: toolCall.toolCallId,
                          toolName: chunkCLKMJINC_cjs.sanitizeToolName(toolCall.toolName),
                          args: toolCall.args,
                          result: toolCall.result
                        },
                        ...providerMetadata ? { providerMetadata } : {}
  ...
  return new web.ReadableStream({
    start: async (controller) => {
      ...
      const executionResult = resumeContext ? await run.resume({
        ...
        ...chunkW26XAFT3_cjs.createObservabilityContext(rest.modelSpanTracker?.getTracingContext()),
        requestContext,
        label: toolCallId
      }) : await run.start({
...
function loop({
  ...
  const internalToUse = {
    ...
    generateId: _internal?.generateId || (() => chunkSPDQUG6O_cjs.generateId()),
...
var MastraLLMVNext = class extends chunkRO47SMI7_cjs.MastraBase {
  ...
  stream({
    resumeContext,
    runId,
    stopWhen = chunkFXGVRQSG_cjs.stepCountIs(5),
    maxSteps,
    tools = {},
    modelSettings,
    toolChoice = "auto",
    ...
    if (maxSteps && typeof maxSteps === "number") {
      stopWhenToUse = chunkFXGVRQSG_cjs.stepCountIs(maxSteps);
    } else {
        ...
        options: {
          ...
          onStepFinish: async (props) => {
            ...
            if (!isNaN(remainingTokens) && remainingTokens > 0 && remainingTokens < 2e3) {
              ...
              await chunkCYZJ2HT2_cjs.delay(10 * 1e3);
            }
          },
...
async function safeParseLLMJson(text) {
  ...
  const { value, state } = await chunkFXGVRQSG_cjs.parsePartialJson(preprocessed);
...
async function prepareMemoryStep({
  ...
  if (typeof messages === "string") {
    ...
    const messageList = new chunkCLKMJINC_cjs.MessageList({
      threadId: thread?.id,
      resourceId: thread?.resourceId
    });
...
async function saveMessagesWithProcessors(memory, messages, processorRunner, context) {
  ...
  await processorRunner.runOutputProcessors(
    messageList,
    chunkW26XAFT3_cjs.resolveObservabilityContext(observabilityContext),
    requestContext
  );
    ...
    execute: async ({ inputData, getInitData, writer, resumeData, mastra, suspend }) => {
      ...
      const finalResult = await tool2.execute(
        inputDataToUse,
        {
          ...
          ...chunkW26XAFT3_cjs.createObservabilityContext({ currentSpan: void 0 }),
          writer
        },
        { toolCallId, messages: [] }
      );
        ...
        if (requireApprovalMetadata || suspendedTools) {
          ...
          `;
              ...
              const result = llm.stream({
                ...
                messageList,
                agentId: routingAgent.id,
                ...chunkW26XAFT3_cjs.resolveObservabilityContext(routingAgentOptions ?? {}),
                structuredOutput: {
                  schema: z9__default.default.object({
...
var AgentLegacyHandler = class {
  ...
  __primitive({
    ...
    return {
      before: async () => {
        ...
        const agentSpan = chunkW26XAFT3_cjs.getOrCreateSpan({
        ...
        const innerObservabilityContext = chunkW26XAFT3_cjs.createObservabilityContext({ currentSpan: agentSpan });
        ...
        let messageList = new chunkCLKMJINC_cjs.MessageList({
          threadId,
          resourceId,
      ...
      after: async ({
        ...
        const messageListResponses = new chunkCLKMJINC_cjs.MessageList({
          threadId,
          resourceId,
          generateMessageId: this.capabilities.mastra?.generateId?.bind(this.capabilities.mastra),
          // @ts-expect-error Flag for agent network messages
        ...
        if (memory && resourceId && thread2) {
          try {
            ...
            if (shouldGenerate && !thread2.title && userMessage) {
              const observabilityContext2 = chunkW26XAFT3_cjs.createObservabilityContext({ currentSpan: agentSpan });
              promises.push(
        ...
        await this.capabilities.runScorers({
          ...
          threadId,
          resourceId,
          ...chunkW26XAFT3_cjs.createObservabilityContext({ currentSpan: agentSpan })
        });
        const scoringData = {
          input: {
  ...
  async prepareLLMOptions(messages, options, methodType) {
    ...
    const { before, after } = this.__primitive({
      ...
      methodType,
      tracingOptions,
      ...chunkW26XAFT3_cjs.resolveObservabilityContext(args)
    });
    let messageList;
    let thread;
    let threadExists;
  ...
  async generateLegacy(messages, generateOptions = {}) {
    ...
    const observabilityContext = chunkW26XAFT3_cjs.createObservabilityContext({ currentSpan: agentSpan });
      ...
      options: {
        ...
        onFinish: async (payload) => {
          if (payload.finishReason === "error") {
            ...
            const isUpstreamError = chunkSPDQUG6O_cjs.APICallError.isInstance(payload.error);
            if (isUpstreamError) {
              const providerInfo = provider ? ` from ${provider}` : "";
...
var prepareMemoryStepOutputSchema = z9.z.object({
  ...
  messageList: z9.z.instanceof(chunkCLKMJINC_cjs.MessageList),
...
var Agent = class extends chunkRO47SMI7_cjs.MastraBase {
  ...
  constructor(config) {
    ...
    if (config.voice) {
      ...
      this.#voice = new chunkB67DPK7Q_cjs.DefaultVoice();
    }
    if (config.workspace) {
  ...
  async #validateRequestContext(requestContext) {
    if (this.#requestContextSchema && chunkCYZJ2HT2_cjs.isZodType(this.#requestContextSchema)) {
      const contextValues = requestContext?.all ?? {};
...
${errorMessages}`,
  ...
  async getVoice({ requestContext } = {}) {
    if (this.#voice) {
      ...
      return new chunkB67DPK7Q_cjs.DefaultVoice();
    }
  }
  /**
  ...
  listTools({ requestContext = new chunk5WBEMKE2_cjs.RequestContext() } = {}) {
    if (typeof this.#tools !== "function") {
      return chunkCYZJ2HT2_cjs.ensureToolProperties(this.#tools);
    }
    ...
    return resolveMaybePromise(result, (tools) => {
      ...
      return chunkCYZJ2HT2_cjs.ensureToolProperties(tools);
    });
  }
  /**
    ...
    return modelSelectionPromise.then((modelSelection) => {
      ...
      return resolveMaybePromise(resolvedModel, (modelInfo) => {
        ...
        if (isSupportedLanguageModel(modelInfo)) {
          ...
          llm = new chunk6IM3BPH2_cjs.MastraLLMV1({
            model: modelInfo,
            mastra: this.#mastra,
            options: { tracingPolicy: this.#options?.tracingPolicy }
          });
  ...
  async resolveModelConfig(modelConfig, requestContext) {
    try {
      return await chunk2AWGYDG4_cjs.resolveModelConfig(modelConfig, requestContext, this.#mastra);
    } catch (error) {
      const mastraError = new chunk4U7ZLI36_cjs.MastraError({
  ...
  async generateTitleFromUserMessage({
    ...
    const normMessage = new chunkCLKMJINC_cjs.MessageList().add(message, "user").get.all.aiV5.ui().at(-1);
    if (!normMessage) {
    ...
    if (isSupportedLanguageModel(llm.getModel())) {
      const messageList = new chunkCLKMJINC_cjs.MessageList().add(
        [
          {
            role: "system",
  ...
  async genTitle(userMessage, requestContext, observabilityContext, model, instructions) {
    try {
      if (userMessage) {
        const normMessage = new chunkCLKMJINC_cjs.MessageList().add(userMessage, "user").get.all.ui().at(-1);
        if (normMessage) {
  ...
  async listMemoryTools({
    ...
    if (memoryTools) {
      ...
      for (const [toolName, tool2] of Object.entries(memoryTools)) {
        ...
        const convertedToCoreTool = chunkCYZJ2HT2_cjs.makeCoreTool(toolObj, options, void 0, autoResumeSuspendedTools);
  ...
  async listWorkspaceTools({
    ...
    const workspaceTools = chunkHACNMOMO_cjs.createWorkspaceTools(workspace);
  ...
  async listSkillTools({
    ...
    const skillTools = chunkHACNMOMO_cjs.createSkillTools(workspace.skills);
  ...
  async listAssignedTools({
    ...
    const assignedCoreToolEntries = await Promise.all(
      assignedToolEntries.map(async ([k, tool2]) => {
        ...
        return [k, chunkCYZJ2HT2_cjs.makeCoreTool(tool2, options, void 0, autoResumeSuspendedTools)];
      })
    );
    ...
    if (toolsFromToolsets.length > 0) {
      ...
      for (const toolset of toolsFromToolsets) {
        for (const [toolName, tool2] of Object.entries(toolset)) {
          ...
          const convertedToCoreTool = chunkCYZJ2HT2_cjs.makeCoreTool(toolObj, options, "toolset", autoResumeSuspendedTools);
  ...
  async listClientTools({
    ...
    if (clientToolsForInput.length > 0) {
      ...
      for (const [toolName, tool2] of clientToolsForInput) {
        ...
        const convertedToCoreTool = chunkCYZJ2HT2_cjs.makeCoreTool(toolRest, options, "client-tool", autoResumeSuspendedTools);
        toolsForRequest[toolName] = convertedToCoreTool;
      }
    }
    return toolsForRequest;
...
${effectiveInstructions}`;
            ...
            try {
              ...
              if ((methodType === "generate" || methodType === "generateLegacy") && supportedLanguageModelSpecifications.includes(modelVersion)) {
                const generateResult = resumeData ? await agent.resumeGenerate(resumeData, {
                  ...
                  requestContext,
                  ...chunkW26XAFT3_cjs.resolveObservabilityContext(context ?? {}),
        ...
        convertedAgentTools[`agent-${agentName}`] = chunkCYZJ2HT2_cjs.makeCoreTool(
          toolObj,
          options,
          void 0,
          autoResumeSuspendedTools
  ...
  async listWorkflowTools({
    ...
    if (Object.keys(workflows).length > 0) {
      for (const [workflowName, workflow] of Object.entries(workflows)) {
        ...
        convertedWorkflowTools[`workflow-${workflowName}`] = chunkCYZJ2HT2_cjs.makeCoreTool(
          toolObj,
          options,
          void 0,
          autoResumeSuspendedTools
  ...
  async convertTools({
    ...
    if (this.#mastra) {
      mastraProxy = chunkCYZJ2HT2_cjs.createMastraProxy({ mastra: this.#mastra, logger });
    }
  ...
  async prepareModels(requestContext, resolvedSelection) {
    ...
    if (!Array.isArray(selection)) {
      ...
      let headers;
      if (resolvedModel instanceof chunk2AWGYDG4_cjs.ModelRouterLanguageModel) {
    ...
    const models = await Promise.all(
      selection.map(async (modelConfig) => {
        ...
        let headers;
        if (model instanceof chunk2AWGYDG4_cjs.ModelRouterLanguageModel) {
  ...
  async generate(messages, options) {
    ...
    const mergedOptions = chunkCYZJ2HT2_cjs.deepMerge(
      defaultOptions,
      options ?? {}
    );
  ...
  async resumeStream(resumeData, streamOptions) {
    ...
    let mergedStreamOptions = chunkCYZJ2HT2_cjs.deepMerge(
      defaultOptions,
      streamOptions ?? {}
    );
    const llm = await this.getLLM({
  ...
  getEncoder() {
    if (!this.encoderPromise) {
      if (this.customEncoding) {
        ...
        this.encoderPromise = chunkHACNMOMO_cjs.getTiktoken();
      }
    }
...
var ToolSearchProcessor = class {
  ...
  constructor(options) {
    ...
    this.bm25Index = new chunkHACNMOMO_cjs.BM25Index({}, TOOL_SEARCH_TOKENIZE_OPTIONS);
    this.indexTools();
    if (this.ttl > 0) {
...
`;
  ...
  generateEmptyFromSchema(schema) {
    try {
      ...
      return chunkCYZJ2HT2_cjs.generateEmptyFromSchema(schema);
    } catch {
      return null;
    }
  }
...
var SemanticRecall = class {
  ...
  formatCrossThreadMessages(messages, currentThreadId) {
    let result = ``;
    const v1Messages = new chunkCLKMJINC_cjs.MessageList().add(messages, "memory").get.all.v1();
    let lastYmd = null;
...
https://mastra.ai/en/docs/memory/semantic-recall`
      ...
      if (typeof config.embedder === "string") {
        this.embedder = new chunk2AWGYDG4_cjs.ModelRouterEmbeddingModel(config.embedder);
      } else {
...
https://mastra.ai/en/docs/memory/overview`
  ...
  setEmbedder(embedder, embedderOptions) {
    if (typeof embedder === "string") {
      this.embedder = new chunk2AWGYDG4_cjs.ModelRouterEmbeddingModel(embedder);
    } else {
  ...
  getMergedThreadConfig(config) {
    ...
    const mergedConfig = chunkCYZJ2HT2_cjs.deepMerge(this.threadConfig, config || {});
...
var MockMemory = class extends MastraMemory {
  constructor({
    ...
    super({
      name: "mock",
      storage: storage || new chunkSHN25XWN_cjs.InMemoryStore(),
      options: {
...
//# sourceMappingURL=chunk-F5254W6E.cjs.map
//# sourceMappingURL=chunk-F5254W6E.cjs.map