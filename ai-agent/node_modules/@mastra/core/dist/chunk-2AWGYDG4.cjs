...
var chunkVX2T4M3C_cjs = require('./chunk-VX2T4M3C.cjs');
var chunkFVP6VEKR_cjs = require('./chunk-FVP6VEKR.cjs');
var chunk4MKCST44_cjs = require('./chunk-4MKCST44.cjs');
var chunkLJMYIOTZ_cjs = require('./chunk-LJMYIOTZ.cjs');
...
var AISDKV6LanguageModel = class {
  ...
  async doGenerate(options) {
    ...
    return {
      ...
      stream: chunk6IM3BPH2_cjs.createStreamFromGenerateResult(result)
    };
  }
...
// ../../node_modules/.pnpm/@ai-sdk+provider-utils@3.0.17_zod@4.3.6/node_modules/@ai-sdk/provider-utils/dist/index.mjs
var dist_exports = {};
chunkBVWXTWXP_cjs.__export(dist_exports, {
  EventSourceParserStream: () => chunk4MKCST44_cjs.EventSourceParserStream,
  VERSION: () => VERSION,
  asSchema: () => asSchema,
...
function parseJsonEventStream({
  ...
  return stream.pipeThrough(new TextDecoderStream()).pipeThrough(new chunk4MKCST44_cjs.EventSourceParserStream()).pipeThrough(
    new TransformStream({
...
// ../../node_modules/.pnpm/@ai-sdk+azure@2.0.74_zod@4.3.6/node_modules/@ai-sdk/azure/dist/index.mjs
...
var AzureOpenAIGateway = class extends chunk4MKCST44_cjs.MastraModelGateway {
  constructor(config) {
    super();
    this.config = config;
    this.validateConfig();
  ...
  async resolveLanguageModel({
    ...
    return createAzure({
      ...
      headers: { "User-Agent": chunk4MKCST44_cjs.MASTRA_USER_AGENT, ...headers }
    })(modelId);
  }
};
...
function getStaticProvidersByGateway(name14) {
  return Object.fromEntries(Object.entries(chunkLJMYIOTZ_cjs.PROVIDER_REGISTRY).filter(([_provider, config]) => config.gateway === name14));
}
var defaultGateways = [new chunkFVP6VEKR_cjs.NetlifyGateway(), new chunkVX2T4M3C_cjs.ModelsDevGateway(getStaticProvidersByGateway(`models.dev`))];
var ModelRouterLanguageModel = class _ModelRouterLanguageModel {
  ...
  constructor(config, customGateways) {
    ...
    const parsed = chunkVX2T4M3C_cjs.parseModelRouterId(normalizedConfig.id, gatewayPrefix);
  ...
  async _fetchSupportedUrls() {
    ...
    try {
      ...
      const model = await this.resolveLanguageModel({
        ...
        ...chunkVX2T4M3C_cjs.parseModelRouterId(this.config.routerId, gatewayPrefix)
      });
  ...
  async doGenerate(options) {
    ...
    const aiSDKV5Model = new chunk6IM3BPH2_cjs.AISDKV5LanguageModel(model);
  ...
  async resolveLanguageModel({
    ...
    if (this.config.url) {
      const modelInstance2 = chunk4MKCST44_cjs.createOpenAICompatible({
        name: providerId,
        apiKey,
  ...
  resolveOpenAIWebSocketModel({
    ...
    const modelInstance = chunk4MKCST44_cjs.createOpenAI({
      apiKey,
      baseURL,
      headers,
      fetch: wsFetch
...
async function resolveModelConfig(modelConfig, requestContext = new chunk5WBEMKE2_cjs.RequestContext(), mastra) {
  ...
  if (modelConfig instanceof ModelRouterLanguageModel || modelConfig instanceof chunk6IM3BPH2_cjs.AISDKV5LanguageModel || modelConfig instanceof AISDKV6LanguageModel) {
    return modelConfig;
  }
  if (typeof modelConfig === "object" && "specificationVersion" in modelConfig) {
    if (modelConfig.specificationVersion === "v2") {
      return new chunk6IM3BPH2_cjs.AISDKV5LanguageModel(modelConfig);
    }
...
var ModelRouterEmbeddingModel = class {
  ...
  constructor(config) {
    ...
    if (normalizedConfig.url) {
      ...
      this.providerModel = chunk4MKCST44_cjs.createOpenAICompatible({
      ...
      const registry = chunkLJMYIOTZ_cjs.GatewayRegistry.getInstance();
      ...
      if (normalizedConfig.providerId === "openai") {
        this.providerModel = chunk4MKCST44_cjs.createOpenAI({ apiKey }).textEmbeddingModel(
          normalizedConfig.modelId
        );
      } else if (normalizedConfig.providerId === "google") {
        this.providerModel = chunk4MKCST44_cjs.createGoogleGenerativeAI({ apiKey }).textEmbedding(
          normalizedConfig.modelId
        );
      } else {
...
//# sourceMappingURL=chunk-2AWGYDG4.cjs.map
//# sourceMappingURL=chunk-2AWGYDG4.cjs.map