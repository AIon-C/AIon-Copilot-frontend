...
var chunk2QLJVF77_cjs = require('./chunk-2QLJVF77.cjs');
...
function applyCompatLayer({
  ...
  if (mode === "jsonSchema") {
    const standardSchema = chunk2QLJVF77_cjs.toStandardSchema(schema);
    for (const compat of compatLayers) {
      if (compat.shouldApply()) {
        return compat.processToJSONSchema(standardSchema);
      }
    }
    return chunk2QLJVF77_cjs.standardSchemaToJSONSchema(standardSchema);
  } else {
    let zodSchema2;
    if (isZodType(schema)) {
      zodSchema2 = schema;
    } else {
      if (chunk2QLJVF77_cjs.isStandardSchemaWithJSON(schema)) {
...
var SchemaCompatLayer3 = class {
  ...
  processToJSONSchema(zodSchema2, io = "input") {
    const standardSchema = chunk2QLJVF77_cjs.toStandardSchema(zodSchema2);
    const jsonSchema2 = chunk2QLJVF77_cjs.standardSchemaToJSONSchema(standardSchema, {
      target: "draft-07",
      io
...
function applyOpenAICompatTransforms(schema, modelInfo) {
  ...
  return chunk2QLJVF77_cjs.toStandardSchema(processedZodSchema);
}
...
Object.defineProperty(exports, "JSON_SCHEMA_LIBRARY_OPTIONS", {
  enumerable: true,
  get: function () { return chunk2QLJVF77_cjs.JSON_SCHEMA_LIBRARY_OPTIONS; }
});
Object.defineProperty(exports, "isStandardJSONSchema", {
  enumerable: true,
  get: function () { return chunk2QLJVF77_cjs.isStandardJSONSchema; }
});
Object.defineProperty(exports, "isStandardSchema", {
  enumerable: true,
  get: function () { return chunk2QLJVF77_cjs.isStandardSchema; }
});
Object.defineProperty(exports, "isStandardSchemaWithJSON", {
  enumerable: true,
  get: function () { return chunk2QLJVF77_cjs.isStandardSchemaWithJSON; }
});
Object.defineProperty(exports, "standardSchemaToJSONSchema", {
  enumerable: true,
  get: function () { return chunk2QLJVF77_cjs.standardSchemaToJSONSchema; }
});
Object.defineProperty(exports, "toStandardSchema", {
  enumerable: true,
  get: function () { return chunk2QLJVF77_cjs.toStandardSchema; }
});
