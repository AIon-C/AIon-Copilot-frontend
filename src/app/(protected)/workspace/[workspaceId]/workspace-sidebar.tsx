...
export const WorkspaceSidebar = () => {
  ...
  if (memberLoading || workspaceLoading || channelsLoading || membersLoading) {
    return (
      <div className="flex h-full flex-col items-center justify-center bg-[#1f1f20]">
  ...
  if (!workspace || !member) {
    return (
      <div className="flex h-full flex-col items-center justify-center gap-y-2 bg-[#1f1f20]">
  ...
  return (
    <div className="flex h-full flex-col gap-y-2 bg-[#1f1f20] text-slate-100">
