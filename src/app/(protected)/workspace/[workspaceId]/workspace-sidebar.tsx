...
export const WorkspaceSidebar = () => {
  ...
  if (memberLoading || workspaceLoading || channelsLoading || membersLoading) {
    return (
      <div className="flex h-full flex-col items-center justify-center bg-[#0f172a]/95">
  ...
  if (!workspace || !member) {
    return (
      <div className="flex h-full flex-col items-center justify-center gap-y-2 bg-[#0f172a]/95">
  ...
  return (
    <div className="flex h-full flex-col gap-y-2 bg-[#0f172a]/95 text-slate-100">
