...
import type { LogInResponse, RefreshTokenResponse, SignUpResponse } from '@/gen/chatapp/auth/v1/auth_service_pb';
...
export function mapAuthResponse(response: SignUpResponse | LogInResponse): AuthResult {
  return {
...
export function mapRefreshResponse(response: RefreshTokenResponse, fallbackRefreshToken: string | null): AuthTokens {
